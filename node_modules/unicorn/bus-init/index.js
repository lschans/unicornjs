...
exports.getChannel = function (Channel) {
    ...
    if (Channel.search('broker') != -1){ // Checking if the service is a broker!
        ...
        brokerClient.on('message', function (channel, message) {
            ...
            if (!busmsg.verify(msg)) {
                ...
                // Assign a broker
                businit.areThereBrokers().then(function (boolean) {
                    if (boolean){
...
exports.checkBrokerFlag = function  (){
...
exports.activateBrokerFlag = function (){
    return new Promise(function (resolve, reject) {
        publishClient.HGETALL('broker', function (err, hash) {
            if (err) reject(err)
            else{
...
exports.areThereBrokers = function(){
    return new Promise(function (resolve, reject) {
        publishClient.HGETALL('broker', function (err, hash) {
            if (err) reject(err)
            else{
