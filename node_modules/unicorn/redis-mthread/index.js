       ...
       if(typeof(message.type) !== 'undefined'){
           ...
           switch(message.type){
               ...
               case 'EXIT': // Mind if you receive an exit, than you must exit
                   console.log('Kill signal received jobs:' + jobCount);
                   while(true){ // Keep looping untill we are idle, this should be soon since the master stopped sending jobs to me
                       if(jobCount == 0) {
