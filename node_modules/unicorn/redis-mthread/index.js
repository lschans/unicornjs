...
module.exports = function (config, redis) {
   var cluster = require('cluster'),
       masterObj = require(Path.join(config.rootdir, 'unicorn_services', config.process.name, config.process.masterCode)),
       workerObj = require(Path.join(config.rootdir, 'unicorn_services', config.process.name, config.process.workerCode));
...
*/
       ...
       if(typeof(masterObj.startLogic) == 'function') masterObj.startLogic(config, redis);
